...
class acp_versions
{
	...
	function read()
	{
		$this->data = array(
			...
			'Ram' => array(
				'author' => 'Ram & crewstyle',
				'author_url' => 'http://crewstyle.fr',
				'host' => 'stylemod.hostarea.org',
				'file' => '/premod_version_check/premod_versions.dta',
				'protocol' => 'multiple',
				'mods' => array(
					'premod_version' => array('name' => 'StyleMOD', 'desc' => '', 'page' => 'http://www.ezcom-fr.com/'), 
				),
			),
		);
	}
