...
if( !empty($setmodules) )
{
	...
	$module['Attach_Extensions']['Extension_control'] = $filename . '?mode=extensions';
	$module['Attach_Extensions']['Extension_group_manage'] = $filename . '?mode=groups';
	$module['Attach_Extensions']['Forbidden_extensions'] = $filename . '?mode=forbidden';
	return;
}
