...
if( !empty($setmodules) )
{
	...
	$module['Attach_Attachments']['Manage'] = $filename . '?mode=manage';
	$module['Attach_Attachments']['Shadow_attachments'] = $filename . '?mode=shadow';
	$module['Attach_Extensions']['Special_categories'] = $filename . '?mode=cats';
	$module['Attach_Attachments']['Sync_attachments'] = $filename . '?mode=sync';
	$module['Attach_Attachments']['Quota_limits'] = $filename . '?mode=quota';
	return;
}
