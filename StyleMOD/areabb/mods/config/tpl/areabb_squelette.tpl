...
<tr>
	...
	<td class="catLeft" height="28" align="center" width="150"><span class="cattitle">{L_DEFAULT}</span></td>
	<td class="catLeft" height="28" align="center" width="200"><span class="cattitle">{L_EDITION}</span></td>
...
<tr>
	<td class="row1" nowrap="nowrap" width="50%">
