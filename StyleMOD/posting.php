...
//	, post_icon
//-- modify
				submit_post($mode, $post_data, $return_message, $return_meta, $forum_id, $topic_id, $post_id, $poll_id, $topic_type, $bbcode_on, $html_on, $smilies_on, $attach_sig, $bbcode_uid, str_replace("\'", "''", $username), str_replace("\'", "''", $subject), str_replace("\'", "''", $description), str_replace("\'", "''", $message), str_replace("\'", "''", $poll_title), $poll_options, $poll_length, $attribute_id, $post_icon);
//-- fin mod : quick title edition ---------------------------------------------
//-- fin mod : post description ------------------------------------------------
//-- fin mod : post icon ---------------------------------------------------------------------------
			}
