...
//	, &$flag
//-- modify
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$coppa, &$username, &$email, &$new_password, &$cur_password, &$password_confirm, &$icq, &$aim, &$msn, &$skype, &$yim, &$website, &$location, &$occupation, &$interests, &$flag, &$bday_day, &$bday_month, &$bday_year, &$browser, &$signature, &$viewemail, &$notifypm, &$popup_pm, &$notifyreply, &$attachsig, &$allowhtml, &$allowbbcode, &$allowsmilies, &$user_absent, &$hideonline, &$style, &$language, &$timezone, &$dateformat, &$session_id, &$user_qp_settings, &$gender)
//-- fin mod : birthday --------------------------------------------------------
