...
class Template {
	...
	{
		global $board_config;
		if (ereg('areabb/mods/',$filename) && (ROOT_STYLE == 'admin')) $filename = '../../'.$filename;
		if (ereg('areabb/cache/',$filename) && (ROOT_STYLE == 'page')) $filename = '../../'.$filename;
		if (ereg('areabb/mods/',$filename) && (ROOT_STYLE == 'page')) $filename = '../../'.$filename;
		if (ROOT_STYLE == 'admin')
		{
			$this->assign_vars(array('ROOT_STYLE'=>'../../../'));
		}else{
			$this->assign_vars(array('ROOT_STYLE'=>'../'));
		}		
