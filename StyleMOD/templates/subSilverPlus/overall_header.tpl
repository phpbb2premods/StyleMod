	...
	<td class="bodyline"><table width="100%" cellspacing="0" cellpadding="0" border="0">
	  <tr>
		<td align="center" class="mainmenu">
			<a href="news.php" class="mainmenu"><img src="templates/subSilverPlus/images/icon_home.gif" border="0" alt="" hspace="3" />News</a>
			&nbsp;<a href="arcade.php" class="mainmenu"><img src="templates/subSilverPlus/images/icon_mini_arcade.gif" width="12" height="13" border="0" alt="FAQ" hspace="3" />Arcade</a>
