...
{S_HIDDEN_FIELDS}
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
	  <td class="row1">{L_CNIL_ID}<br /><span class="gensmall">{L_CNIL_ID_EXPLAIN}</span></td>
	  <td class="row2"><input class="post" type="text" maxlength="8" size="10" name="cnil_id" value="{CNIL_ID}" /></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td class="row2"><input class="post" type="text" size="40" maxlength="255" name="reason" value="{REASON}" /></td>
	</tr>
	<tr>
	  <td class="row1">{L_REGISTRATION_STATUS}<br /><span class="gensmall">{L_REGISTRATION_STATUS_EXPLAIN}</span></td>
	  <td class="row2">
		<input type="radio" name="registration_status" value="1" {S_REGISTRATION_STATUS_YES} /> {L_YES}&nbsp;
	...
	<tr>
	  <td class="row1">{L_BUMP_INTERVAL}<br /><span class="gensmall">{L_BUMP_INTERVAL_EXPLAIN}</span></td>
	  <td class="row2">{S_BUMP_INTERVAL}</td>
	</tr>
	<tr>
	  <td class="row1">{L_REPLY_FLOOD_CTRL}<br /><span class="gensmall">{L_REPLY_FLOOD_CTRL_EXPLAIN}</span></td>
	  <td class="row2">
		<input type="radio" name="reply_flood_ctrl" value="1"{REPLY_FLOOD_CTRL_YES} />{L_YES}&nbsp;
		<input type="radio" name="reply_flood_ctrl" value="0"{REPLY_FLOOD_CTRL_NO} />{L_NO}
	  </td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td class="row2"><span class="genmed">
			<select name="dateoptions" id="dateoptions" onchange="if (this.value == 'custom') { document.getElementById('default_dateformat').value = '{A_DEFAULT_DATEFORMAT}'; } else { document.getElementById('default_dateformat').value = this.value; }">{S_DATEFORMAT_OPTIONS}</select>&nbsp;<input class="post" type="text" name="default_dateformat" id="default_dateformat" value="{DEFAULT_DATEFORMAT}" maxlength="30" />
		</span></td>
	</tr>
	<tr>
	...
	<tr>
 	...
 	<tr>
   		<td class="row1">{L_IMAGES_MAX_SIZE}<br /><span class="gensmall">{L_IMAGES_MAX_SIZE_EXPLAIN}</span></td>
    		<td class="row2"><input class="post" type="text" size="40" maxlength="5" name="images_max_size" value="{IMAGES_MAX_SIZE}" /></td>
 	</tr>
	<tr>
