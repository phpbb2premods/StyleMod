...
<table class="forumline" width="100%" cellpadding="3" cellspacing="1" border="0">
  ...
  <tr>
	...
	<td width="100%" valign="top" class="row1"><span class="postdetails">
		...
		<img src="{searchresults.MINI_POST_IMG}" alt="" title="{L_FORUM}" border="0" />{L_FORUM}:&nbsp;<a href="{searchresults.U_FORUM}" class="postdetails">{searchresults.FORUM_NAME}</a>
		<!-- BEGIN switch_post_description -->
		<br /><img src="{searchresults.MINI_POST_IMG}" alt="" title="{searchresults.L_MINI_POST_ALT}" border="0" />{L_DESCRIPTION}: {searchresults.POST_DESCRIPTION}
