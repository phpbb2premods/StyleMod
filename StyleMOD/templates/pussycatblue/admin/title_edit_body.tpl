<!-- $Id: title_edit_body.tpl,v 1.7.3 2007/12/02 11:03 OxyGen Powered Exp $ -->
...
<form action="{S_ATTR_ACTION}" method="post"><table class="forumline" cellpadding="4" cellspacing="1" border="0" align="center">
	<tr>
		...
		<tr id="image" style="{DISPLAY_IMAGE}">
			...
			<td class="row2">
				<input class="post" type="text" name="attribute_image" id="attribute_image" value="{ATTRIBUTE_IMAGE}" size="35" maxlength="255" style="margin-top: 3px;" />
			</td>
		</tr>
		<tr>
			<td class="row1">
			...
			<td class="row2">
				<span class="post">
				<input type="checkbox" name="attribute_administrator" value="attribute_administrator" {ADMINISTRATOR_CHECKED} />&nbsp;{ADMINISTRATOR}&nbsp;&nbsp;
				<input type="checkbox" name="attribute_moderator" value="attribute_moderator" {MODERATOR_CHECKED} />&nbsp;{MODERATOR}&nbsp;&nbsp;
				<input type="checkbox" name="attribute_author" value="attribute_author" {AUTHOR_CHECKED} />&nbsp;{AUTHOR}</span>
			</td>
		</tr>
		<tr>
			<td class="row1">
