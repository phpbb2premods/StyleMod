...
<link rel="stylesheet" type="text/css" href="{ROOT_STYLE}{STYLE_PATH}/{T_HEAD_STYLESHEET}" media="all">
<link rel="stylesheet" type="text/css" href="{ROOT_STYLE}templates/{T_TEMPLATE_NAME}/rcs_stylesheet.css" media="all"> 
